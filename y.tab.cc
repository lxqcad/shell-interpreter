...
#define WORD 258
#define GREAT 259
#define GREAT_GREAT 260
#define GREAT_AMP 261
#define GREAT_GREAT_AMP 262
#define LESS 263
...
union YYSTYPE
{
#line 19 "shell.y" /* yacc.c:355  */

		char   *string_val;
	

#line 136 "y.tab.cc" /* yacc.c:355  */
};
...
{
       0,    45,    45,    49,    50,    53,    57,    61,    62,    63,
      67,    74,    75,    79,    80,    84,   104,   112,   113,   114,
     118,   122,   126,   130,   134,   141,   145
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "GREAT", "GREAT_GREAT",
  "GREAT_AMP", "GREAT_GREAT_AMP", "LESS", "AMPERSAND", "NEWLINE", "PIPE",
  "END_OF_FILE", "$accept", "goal", "commands", "command",
  "simple_command", "command_and_args", "pipes_seq", "argument_list",
  "argument", "command_word", "iomodifier_opts", "iomodifier_opt",
  "background", YY_NULLPTR
};
#endif
...
{
       1,    -5,    -6,    -6,    -6,     6,     0,    -6,    -6,    -6,
      -6,    -6,    -6,    -6,    10,     4,     5,    16,    17,    25,
      26,    27,    18,    -6,    -6,    -6,    -6,    -6,    -6,    -6,
      -6,    -6,    -6,    -6,    -1,    -6
};
...
{
       0,     0,    16,     7,     8,     0,     0,     3,     5,    12,
      14,     9,     1,     4,    19,    10,     0,     0,     0,     0,
       0,     0,    26,    17,    15,    13,    20,    23,    22,    24,
      21,    11,    25,    18,     0,     6
};
...
{
      -2,     1,     1,     2,     2,    11,    12,    24,    26,    35,
       3,     3,     4,     4,    16,    17,    18,    19,    20,    27,
      28,    21,    16,    17,    18,    19,    20,    32,    29,    30,
       2,    33,    31,     0,    13
};

static const yytype_int8 yycheck[] =
{
       0,     1,     1,     3,     3,    10,     0,     3,     3,    10,
      10,    10,    12,    12,     4,     5,     6,     7,     8,     3,
       3,    11,     4,     5,     6,     7,     8,     9,     3,     3,
       3,    22,    21,    -1,     6
};
...
{
       0,     1,     3,    10,    12,    14,    15,    16,    17,    18,
      22,    10,     0,    16,    19,    20,     4,     5,     6,     7,
       8,    11,    23,    24,     3,    21,     3,     3,     3,     3,
       3,    18,     9,    24,    25,    10
};
...
#line 1268 "y.tab.cc" /* yacc.c:1646  */
    break;

  case 9:
#line 63 "shell.y" /* yacc.c:1646  */
    { yyerrok; }
#line 1274 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 84 "shell.y" /* yacc.c:1646  */
    {
		(yyvsp[0].string_val) = expandEnvVariables((yyvsp[0].string_val));
        if(strchr((yyvsp[0].string_val), '*') != NULL || strchr((yyvsp[0].string_val), '?') != NULL) {
        	char **retStr = process_wildcards((yyvsp[0].string_val));
            if(retStr != NULL) {
            	int c = 0;
                while(retStr[c] != NULL) {
...
#line 1305 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1351 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1373 "y.tab.cc" /* yacc.c:1646  */
      default: break;
    }
